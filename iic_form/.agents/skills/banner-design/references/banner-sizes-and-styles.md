...
- Critical content in central 70-80% of canvas; for small formats use proportional insets of at least 8% of the shorter edge or a size-specific platform safe zone, whichever is larger.
- Avoid text/CTA within 50-100px of edges on large canvases; on small formats use the proportional inset instead.
...
- Min 44px height for mobile tap targets; for 320 x 50 use a CTA no taller than 34px and at least 12px horizontal inset so it remains legible and tappable.
- Action verbs: "Get", "Start", "Download", "Claim"
- Platform- or size-specific safe-zone and CTA rules override this global guidance when they conflict.
